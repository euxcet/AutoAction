...
public class ExampleCollector extends BaseCollector {
    ...
    public ExampleCollector(Context context, ScheduledExecutorService scheduledExecutorService,
                            List<ScheduledFuture<?>> futureList, RequestListener requestListener,
                            ClickTrigger clickTrigger, Uploader uploader, LogCollector logCollector) {
